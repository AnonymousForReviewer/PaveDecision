...
check_Flexible_Function <- function(sbase2_h, sbase1_h, base_h, pave2_h, pave1_h,
  ...
  # Toán đồ 3.1
  interp_graph31_base_b <- interp(graph31$x_E0_E1, graph31$y_H_D, graph31$Ech_E1,
                                   xo = E0_Edctb_base_b, yo = H_D_base_b, linear = FALSE)

  Echm_Edctb_base_b <- interp_graph31_base_b$z

  Echm_base_b <- Edctb_base_b * interp_graph31_base_b$z
...
# # Etrbinh(250,300,600,1600,1800,18,17,14,8,6)
# 
# check_Flexible_Function(18,17,14,8,6,
#                         42,250,300,600,350,420,
#                         250,300,600,250,300,
#                         250,300,600,1600,1800,
#                         0.8,2,2.8,

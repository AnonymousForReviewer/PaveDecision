...
dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Graph Search", tabName = "graph_search_tab"),
      menuItem("Test System", tabName = "test_system_tab"),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "pavement_design_tab",
              ...
              #######################
              fluidRow(
                box(title = "Rigid Pavement Design", status = "primary", solidHeader = TRUE, width = 8,
                    fluidRow(
                      column(width = 2,
                ...
                box(title = "Rigid Pavement Design Result", status = "primary", solidHeader = TRUE, width = 4,
                    fluidRow(
                      column(width = 12,
              ...
              ##########################
              fluidRow(
                box(title = "Flexible Pavement Design", status = "primary", solidHeader = TRUE, width = 8,
                    fluidRow(
                      column(width = 2,
                ...
                box(title = "Flexible Pavement Design Result", status = "primary", solidHeader = TRUE, width = 4,
                    fluidRow(
                      column(width = 12,
